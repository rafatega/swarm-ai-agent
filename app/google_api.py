...
# Exemplo de uso:
# Substitua o caminho do client_secret_file pelo arquivo correto de credenciais do Google.


if __name__ == "__main__":
    create_service(
        client_secret_file=r"C:\Users\Tega\Documents\Projetos\APIs\client_secret.json",
        api_name='calendar',
        api_version='v3',
